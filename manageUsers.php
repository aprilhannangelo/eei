                          ...
                          <div class="row">
                              <div class="col s12 l6" id="form">
                                ...
                                <div class="row" id="request-form-row">
                                  ...
                                  <div class="row">
                                    <input class="waves-effect waves-light submit" id="request-form" name="submit" type="submit" value="Submit">
                                    <input class="waves-effect waves-light clear" name="clear" type="reset" value="Reset">
                                    <input class="waves-effect waves-light cancel" name="cancel" type="button" id = "cancel" value="Cancel">
                                  </div>
                              </div>
