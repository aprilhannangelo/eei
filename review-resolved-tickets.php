            ...
            <div class="material-table">
              <table id="datatable" class="striped">
                <div class="table-header">
                  <span class="table-title"><b>Resolved Tickets Reviewed</b></span>
                  <div class="actions">
                    <div class="sorter">
                  ...
                  <?php $db = mysqli_connect("localhost", "root", "", "eei_db"); {?>
                    ...
                    <tbody>
                    <?php
                     $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) LEFT JOIN user_access_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_status='Resolved'";
                    ...
                    elseif ($_SESSION['user_type']=='Access Group Manager') {?>
                      <thead>
                        ...
                        <?php
                        $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) LEFT JOIN user_access_ticket_t USING (ticket_id, ticket_number)  WHERE ticket_t.ticket_category='Access' AND ticket_t.ticket_status='Resolved'";
                        $result = mysqli_query($db,$query);?>
                  ...
                  <?php
                    ...
                    elseif ($_SESSION['user_type']=='Technicals Group Manager') {?>
                      ...
                      <tbody>
                      <?php
                        $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_category='Technicals' AND ticket_t.ticket_status='Resolved'";
                        $result = mysqli_query($db,$query);?>
                        ...
                        elseif ($_SESSION['user_type']=='Network Group Manager') {?>
                          ...
                          <tbody>
                          <?php
                            $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_category='Network' AND ticket_t.ticket_status='Resolved'";
                            $result = mysqli_query($db,$query);?>
                    ...
                    <?php
                       ...
                       elseif($_SESSION['user_type'] == 'Network Engineer') {
                          $query = "SELECT * FROM ticket_t LEFT JOIN user_access_ticket_t USING (ticket_id, ticket_number) LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_status='Resolved' AND ticket_t.ticket_category='Network' AND ticket_t.ticket_agent_id = '".$_SESSION['requestor_id']."'";
                           ?>
                           <thead>
                             <tr>
                               <th></th>
