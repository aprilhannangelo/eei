                ...
                <div class="table-header">
                  ...
                  <?php $db = mysqli_connect("localhost", "root", "", "eei_db"); {?>
                    ...
                    //automatic na naupdate ni zairra yung severity and category, pending na yung status
                     $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) LEFT JOIN user_access_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_status='In Progress'";
                    ...
                    elseif ($_SESSION['user_type']=='Access Group Manager') {?>
                      <thead>
                        ...
                        <?php
                        $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) LEFT JOIN user_access_ticket_t USING (ticket_id, ticket_number)  WHERE ticket_t.ticket_category='Access'AND ticket_t.ticket_status='In Progress' ";
                        $result = mysqli_query($db,$query);?>
                  ...
                  <?php
                    ...
                    elseif ($_SESSION['user_type']=='Technicals Group Manager') {?>
                      ...
                      <tbody>
                      <?php
                        $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_category='Technicals' AND ticket_t.ticket_agent_id IS NOT NULL";
                        $result = mysqli_query($db,$query);?>
                        ...
                        elseif ($_SESSION['user_type']=='Network Group Manager') {?>
                          ...
                          <tbody>
                          <?php
                            $query = "SELECT * FROM ticket_t LEFT JOIN user_access_ticket_t USING (ticket_id, ticket_number) LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_status='In Progress' AND ticket_t.ticket_category='Network' AND ticket_t.ticket_agent_id = '".$_SESSION['requestor_id']."'";
                            $result = mysqli_query($db,$query);?>
