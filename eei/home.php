      ...
      <div class="col s12 m12 l10">
        <div class="wrapper">
          <div class="main-container">
                        ...
                        <div class="col s12 l6" id="form">
                          ...
                          <div class="row" id="request-form-row">
                            <div class="col s12">
                              <div class="input-field" id="request-form">
                                <input placeholder="<?php echo $_SESSION['first_name'] . ' '. $_SESSION['last_name'] ?>" class="title" name="rname" type="text" disabled>
                          ...
                          <div class="row" id="request-form-row">
                            ...
                            <div class="row" id="request-form-row">
                              <div class="col s12">
                                <div class="input-field" id="request-form">
                                  <input placeholder=" " class="title" name="title" type="text" data-length="40" class="validate">
            ...
            <!--  ********************************* access ticket **************************************** -->
          <form method="post" action="php_processes/access_ticket_process.php">
                          ...
                          <h6>Request Details</h6>
                            ...
                            <div class="row" id="request-form-row">
                              <div class="col s12">
                                Approver (if any):
                                <div class="input-field inline" id="request-form">
                                  <input type="text" class="validate" name="approver" name="approver">
                                </div>
                              </div>
                            </div>
                            <div class="row" id="request-form-row">
                              <div class="col s12">
                                Checker (if any):
                                <div class="input-field inline" id="request-form">
                                  <input type="text" class="validate" name="checker" name="checker">
                                </div>
                              </div>
                            </div>
                            <div class="row">
