            ...
            <div class="material-table">
              <table id="datatable" class="striped">
                <div class="table-header">
                  <span class="table-title"><b>Pending Tickets Reviewed</b></span>
                  <div class="actions">
                    <div class="sorter">
                  ...
                  <?php $db = mysqli_connect("localhost", "root", "", "eei_db"); {?>
                    ...
                    //automatic na naupdate ni zairra yung severity and category, pending na yung status
                     $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) LEFT JOIN user_access_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_status='Pending'";
                  ...
                  <?php
                    ...
                    <?php
                       ...
                       elseif($_SESSION['user_type'] == 'Network Engineer') {
                           $query = "SELECT * FROM ticket_t LEFT JOIN user_access_ticket_t USING (ticket_id, ticket_number) LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_status='Pending' AND ticket_t.ticket_category='Network' AND ticket_t.ticket_agent_id = '".$_SESSION['requestor_id']."'";
                           ?>
                           <thead>
                             <tr>
                               <th></th>
