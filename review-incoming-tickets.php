                ...
                <div class="table-header">
                  ...
                  <?php $db = mysqli_connect("localhost", "root", "", "eei_db"); {?>
                    ...
                    elseif ($_SESSION['user_type']=='Access Group Manager') {?>
                      <thead>
                        ...
                        <?php
                        $query = "SELECT * FROM ticket_t LEFT JOIN user_access_ticket_t USING (ticket_id, ticket_number)  WHERE ticket_t.ticket_category='Access' AND ticket_t.ticket_status='Pending'";
                        $result = mysqli_query($db,$query);?>
                  ...
                  <?php
                    ...
                    elseif ($_SESSION['user_type']=='Technicals Group Manager') {?>
                      ...
                      <tbody>
                      <?php
                        $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_category='Technicals' AND ticket_t.ticket_agent_id IS NULL";
                        $result = mysqli_query($db,$query);?>
                        ...
                        elseif ($_SESSION['user_type']=='Network Group Manager') {?>
                          ...
                          <tbody>
                          <?php
                            $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id, ticket_number) WHERE ticket_t.ticket_category='Network' AND (ticket_t.ticket_agent_id IS NULL OR ticket_t.ticket_status='Pending')";
                            $result = mysqli_query($db,$query);?>
